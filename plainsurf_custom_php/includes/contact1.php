...
<section class="contact py-5">
    <div class="container py-sm-3">
        <center> <h3 class="heading text-capitalize mb-lg-5 mb-4"> Contact Us - <span>Get In Touch</span> </h3></center>
        ...
        <div class="form row py-5">
            <div class="col-lg-6 contact-form">
                <!-- <form action="../controller/contact_connect.php" method="POST"> -->
                <form action="../process.php" method="POST" enctype='multipart/form-data'>
                    ...
                    <div>
                        <input type="radio" name="opt" value="website"> website
